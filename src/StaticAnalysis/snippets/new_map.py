...
# 7_41
object_1_coords = (9926.312500, 23983.031250)
object_1_pixel = (175, 118) # From top left
...
# 7_41
object_2_coords = (22809.531250, 9070.218750)
object_2_pixel = (913, 966) # From top left
...
x = [i[0] for i in tower_7_41]
y = [i[1] for i in tower_7_41]
axis.scatter(x, y)
